          ...
          <form onSubmit={onSubmit} className="space-y-4">
            <label className="block space-y-2 text-sm">
              ...
              <input
                ...
                className="h-11 w-full rounded-xl border border-white/15 bg-transparent px-3 text-white outline-none transition focus:border-sky-300/60"
              />
            </label>
            ...
            <label className="block space-y-2 text-sm">
              ...
              <textarea
                ...
                className="w-full rounded-xl border border-white/15 bg-transparent px-3 py-3 text-white outline-none transition focus:border-sky-300/60"
              />
            </label>
